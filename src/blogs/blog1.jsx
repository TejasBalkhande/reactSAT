      ...
      <nav className="blog1-navbar">
        <div className="blog1-nav-container">
          ...
          <div className="blog1-nav-links">
            ...
            <Link to="/digital-sat-practice-questions" className="blog1-nav-link">
              Mocks
            </Link>
      ...
      {isMenuOpen && (
        <div className="blog1-mobile-menu active">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <Link to="/digital-sat-practice-questions" className="blog1-nav-link" onClick={() => setIsMenuOpen(false)}>
              Mock Practice
            </Link>
